...
public class TestGetAllWithArgumentFunction implements Function, Declarable {
  
  private final Cache cache;

  public TestGetAllWithArgumentFunction() {
    this.cache = CacheFactory.getAnyInstance();
  }

  public void execute(FunctionContext context) {
    // Get the keys from the argument
    Set<String> keys = (Set<String>) context.getArguments();
    ...
    // Return the results
    context.getResultSender().lastResult(nonNullLocalDataKeysAndValues);
  }
